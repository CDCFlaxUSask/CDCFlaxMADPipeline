...
data MAD.mad_phenotypic_data;
	infile 'K:/2019 Bison x Novelty RIL Wilt Trial/MAD Analysis of BxN 2019/BxN_Preston_Wilt_Data_2019_for_MAD.txt_converted.txt' dlm='09'x LRECL=2400 firstobs=2;
...
data _null_ ;          
    ...
    FILE  'D:\loongf\US\helen\2016mad\unadjusted_subplot_anova_stats.txt' DLM='09'x ;  
...
data _null_ ;          
    ...
    FILE  'D:\loongf\US\helen\2016mad\unadjusted_plot_anova_stats.txt' DLM='09'x ;  
    PUT  Year Location Trait _SOURCE_ DF SS F PROB;
run ; 
